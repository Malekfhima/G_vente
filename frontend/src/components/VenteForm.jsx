...
const VenteForm = ({ vente, produits, onSubmit, onCancel }) => {
  ...
  // Synchroniser le produit sélectionné lorsque la liste des produits ou l'ID change
  useEffect(() => {
    if (formData.produitId && produits.length > 0) {
      const produit = produits.find(
        (p) => p.id === parseInt(formData.produitId)
      );
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              {vente
                ? "Modifiez les détails de la vente"
                : "Créez une nouvelle vente en sélectionnant un produit"}
            </p>
          </div>
                  ...
                  {filteredProduits.length > 0 &&
                    filteredProduits.map((produit) => (
                      <option key={produit.id} value={produit.id}>
                        {produit.nom} - {produit.categorie || "Sans catégorie"}{" "}
                        - Stock: {produit.stock} -{" "}
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border border-green-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                ...
                <div className="bg-white p-4 rounded-lg border border-green-200">
                  ...
                  <p className="text-gray-900 font-semibold">
                    {selectedProduit.categorie || "Non définie"}
                  </p>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg border border-green-200">
                  ...
                  <p className="text-gray-900 font-semibold text-lg">
                    {formatCurrency(selectedProduit.prix)}
                  </p>
                </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        ...
                        {formatCurrency(selectedProduit.prix)} ={" "}
                        {formatCurrency(
                          selectedProduit.prix * formData.quantite
                        )}
                      </p>
                    </div>
              ...
              <div className="mt-4 p-4 bg-white rounded-lg border border-gray-200">
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-600">
                    ...
                    {formData.quantite} × {selectedProduit.nom}
                  </div>
